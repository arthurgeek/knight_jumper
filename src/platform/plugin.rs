...
use super::systems::{
    load_platform_texture, spawn_moving_platforms, spawn_platform_at_spawn_point,
...
impl Plugin for PlatformPlugin {
    fn build(&self, app: &mut App) {
        app.register_type::<OneWayPlatform>()
            ...
            .register_type::<MovingPlatformSpawn>()
            .register_type::<PlatformTexture>()
            .add_systems(Startup, load_platform_texture)
            .add_systems(
                Update,
                (spawn_platform_at_spawn_point, spawn_moving_platforms),
            )
